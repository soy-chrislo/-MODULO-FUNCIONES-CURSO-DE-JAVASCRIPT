...
export function sortModule (): void {
  ...
  const numeros = [1, 34, 2, 3, 41, 5, 35, 6, 343]
  /*
  ...
  */
  ...
  // * Ascendente
  console.log('Ascendente ', numeros.sort((a: any, b: any) => a - b))
  // * Descendente
  console.log('Descendente ', numeros.sort((a: any, b: any) => b - a))
  // * A es mayor que B, ascendente
  console.log('A es mayor que B, ascendente ', numeros.sort((a: any, b: any) => a > b ? 1 : -1))
  // * A es menor que B, descendente
  console.log('A es menor que B, descendente ', numeros.sort((a: any, b: any) => a < b ? 1 : -1))
  ...
  const textos = ['a', '[A', 'z', 'e', '1A', 'r', 't', 'y', '1a', '4r', 'u', 'i', 'o', 'p']
  /*
    1. Numéros
  ...
  console.log('A es mayor que B, ascendente: ', textos.sort((a: any, b: any) => a > b ? 1 : -1))
  // * Siempre que A sea menor que B, se ordenará de forma descendente.
  console.log('A es menor que B, descendente', textos.sort((a: any, b: any) => a < b ? 1 : -1))
  // ! La operación aritmética no hace efecto en caracteres.
  // * Restando A con B
  console.log('Restando A con B: ', textos.sort((a: any, b: any) => a - b))
  // * Restando B con A
  console.log('Restando B con A: ', textos.sort((a: any, b: any) => b - a))

  // ! TEST
  // * Se rompe todo, no se ordena.
  console.log('Retornando 0: ', textos.sort((a: any, b: any) => 0))
  console.log('Retornando 1: ', textos.sort((a: any, b: any) => 1))
}

export function sortPractice (): void {
  // Repasando el algoritmo de sort

  const numeros = [1, 34, 2, 3, 41, 5, 35, 6]
